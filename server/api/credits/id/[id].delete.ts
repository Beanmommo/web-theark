...
export default defineEventHandler(async event =>
{
  ...
  try
  {
    ...
    {
      await fsRef.delete();
      console.log(`Deleted credit package ${id} from Firestore`);
  ...
  try
  {
    ...
    if (snapshot.exists())
    {
      ...
      console.log(`Deleted credit package ${id} from RTDB`);
  ...
  return { success: false, error: 'Credit package not found', id };
})
