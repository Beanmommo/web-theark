  ...
  <SectionContainer v-if="selectedVenue">
    <div class="venue__contact_info">
      ...
      <span class="contact_info__details">
        <p>
          <VIcon :color="sportColor" class="mr-2" icon="mdi-phone" />{{
            selectedVenue.contact
          }}
        </p>
        <p>
          <VIcon :color="sportColor" class="mr-2" icon="mdi-email" />{{
            selectedVenue.email
          }}
        </p>
      </span>
...
function nextImage() {
  if (
    selectedVenue.value &&
    currentImageIndex.value < selectedVenue.value.gallery.length - 1
  ) {
